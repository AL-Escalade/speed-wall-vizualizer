...
import type { ReferenceRoute, ReferenceRoutes, Hold, PanelId, PanelSide, PanelNumber, InsertPosition, Column, Row } from '@voie-vitesse/core';
...
function parseInsertPosition(posStr: string): InsertPosition {
  ...
  return {
    column: match[1].toUpperCase() as Column,
    row: parseInt(match[2], 10) as Row,
  };
}
