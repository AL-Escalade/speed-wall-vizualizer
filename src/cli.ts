...
import { composeAllRoutes } from './route-composer.js';
import { writeOutput, formatFromPath, getExtension } from './output/index.js';
import { getAvailableRouteNames, getReferenceRoute } from './reference-routes/index.js';
...
async function main(): Promise<void> {
  ...
  try {
    ...
    const allHolds = composeAllRoutes(config.routes);
